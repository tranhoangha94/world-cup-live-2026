...
export const knockoutMatches: Match[] = [
  ...
  },
  {
    ...
    venue: "Sân vận động Hard Rock, Miami",
    events: [
      { minute: "36'", type: EventType.GOAL, player: "Andreas Schjelderup", team: "home", detail: "Sút xa đổi hướng — Na Uy dẫn trước" },
      { minute: "45+2'", type: EventType.GOAL, player: "Jude Bellingham", team: "away", detail: "Gỡ hòa trước giờ nghỉ (kiến tạo: Anthony Gordon)" },
      { minute: "93'", type: EventType.GOAL, player: "Jude Bellingham", team: "away", detail: "Tận dụng pha mất bóng của Nyland — bàn thắng ở hiệp phụ" },
    ],
    stats: {
    ...
    lineups: [
      { name: "Jude Bellingham", position: "CM", team: "away", rating: 9.0 },
      { name: "Jordan Pickford", position: "GK", team: "away", rating: 8.2 },
      { name: "Andreas Schjelderup", position: "LW", team: "home", rating: 7.8 },
      { name: "Erling Haaland", position: "ST", team: "home", rating: 7.2 },
      { name: "Ørjan Nyland", position: "GK", team: "home", rating: 7.0 },
    ],
  },
  {
    id: "qf_4",
    ...
    events: [
      ...
      { minute: "112'", type: EventType.GOAL, player: "Julián Álvarez", team: "away", detail: "Sút xa đổi hướng — Argentina dẫn lại ở hiệp phụ" },
      { minute: "120+1'", type: EventType.GOAL, player: "Lautaro Martínez", team: "away", detail: "Chốt hạ sau pha cứu thua của Kobel" },
    ],
  },
